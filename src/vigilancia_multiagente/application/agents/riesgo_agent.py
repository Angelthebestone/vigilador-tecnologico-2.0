...
class RiesgoAgent(BaseBranchAgent):
    def __init__(
        self,
        ...
        super().__init__(BranchType.RIESGO, governance_loader, provider_registry, execution_client, embedding_gateway, minimax_client, system_base, prompt_composer)
